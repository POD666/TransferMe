    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(default=Decimal('0.0'), max_digits=10, decimal_places=2, default_currency=b'USD')),
                ('description', models.TextField()),
                ('photo', models.ImageField(upload_to=b'car_main_photo')),
                ...
                ('place_from', models.ForeignKey(related_name='place_from', to='core.Place')),
                ('place_to', models.ForeignKey(related_name='place_to', to='core.Place')),
